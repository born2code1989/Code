...
@WebServiceClient(name = "HelloWorldImplService", targetNamespace = "http://ws.borntocode.com/", wsdlLocation = "http://localhost:9999/ws/hello?wsdl")
public class HelloWorldImplService extends Service {
	...
	private final static QName HELLOWORLDIMPLSERVICE_QNAME = new QName(
			"http://ws.borntocode.com/", "HelloWorldImplService");
	...
	public HelloWorld getHelloWorldImplPort() {
		return super.getPort(new QName("http://ws.borntocode.com/",
